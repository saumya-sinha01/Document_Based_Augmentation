...
import transformers
from transformers import LayoutLMv3Processor, LayoutLMv3ForTokenClassification, LayoutLMv2FeatureExtractor, LayoutLMv3FeatureExtractor
...
image = load_image(input_path_image)
labels = load_tags()

# loads the model
feature_extractor, processor, model = load_models()


# gets the bounding boxes, predictions, extracted words and image processed
kp = process_image(image, feature_extractor, processor, model, labels)
print(kp)